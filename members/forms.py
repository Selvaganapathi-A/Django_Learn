...
class RegisterUserForm(UserCreationForm):
    ...
    firstname = forms.CharField(max_length=50, widget=forms.widgets.TextInput(attrs={
        'class':'form-control fw-300'
    }))
    lastname = forms.CharField(max_length=50, widget=forms.widgets.TextInput(attrs={
        'class':'form-control fw-300'
    }))
    address = forms.CharField(max_length=200, widget=forms.widgets.Textarea(attrs={
        'class':'form-control fw-300',
        'cols':'15',
        'rows':'5',
    }))
